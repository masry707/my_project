...
ActiveRecord::Schema.define(version: 20151129111356) do
  ...
  add_index "needs", ["ingredient_id"], name: "index_needs_on_ingredient_id"
  add_index "needs", ["recipe_id"], name: "index_needs_on_recipe_id"
